...
namespace CodeMonkey.Utils {
    ...
    public class World_Mesh {
        ...
        public static World_Mesh CreateGood(Vector3 position, float eulerZ, float meshWidth, float meshHeight, Material material, UVCoords uvCoords, int sortingOrderOffset = 0) {
